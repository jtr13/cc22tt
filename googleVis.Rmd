...
op <- options(gvis.plot.tag='chart') # Display Charts in Rmd - googleVis plot option
```
...
#plot(Merged_Charts,browser=rstudioapi::viewer)
plot(Merged_Charts)
```
