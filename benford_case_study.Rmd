...
Let us try an experiment to see if we can use Benford's Law to detech potential data manipulation. We'll use random data for this where we can pretend a company has data made up of prices and quantities of items that they have sold.
...
value2 <- sample(1:99999, size = 50000, replace=TRUE)
