...
Section 4: Example Usage of benford.analysis
...
Here is a comparison of the statistics between the two dataframes:
...
Section 5 Conclusion: Show what we learned, its drawbacks, future readings on the package.
